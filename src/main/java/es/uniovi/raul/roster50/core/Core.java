...
public class Core {
    ...
    public static final int NO_CHANGES = 2; // The teams are already up to date, no changes were made
    ...
    public static int run(List<RosterEntry> oldRoster, List<RosterEntry> newRoster, String newStudentsFile)
        ...
        if (!diff.hasChanges()) {
            System.out.println("The teams are already up to date, no changes were made.");
            return NO_CHANGES;
        }
